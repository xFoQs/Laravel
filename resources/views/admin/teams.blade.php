...
<div id="content" style="padding-top:5rem; height:100%;">
    ...
    <div class="contenthead" style="display: flex; align-items: stretch; margin-bottom: 1rem; margin-top: 2rem; align-content: center;">
        <h1 style="margin-right: 1rem;">Drużyny</h1>
...
<table id="example" class="table table-borderless" style="width:100%; padding-top: 1rem;">
    ...
    @foreach ($teams as $team)
        ...
        <tr data-entry-id="{{ $team->id }}">
            ...
            <td class="align-middle">
                @if ($team->photo)
                    <div class="d-flex align-items-center">
                        <img src="/img/{{ $team->photo }}" alt="{{ $team->name }}" style="max-width: 35px; max-height: 45px; margin-right: 10px;">
                        {{ $team->name }}
                    </div>
                @else
                    <div class="d-flex align-items-center">
            ...
            <td class="align-middle">{{ $team->league->name }}</td>
            <td>
                <button class="btn btn-primary btn-sm" data-bs-toggle="modal" data-bs-target="#editteam{{$team->id}}" title="Edycja">
                    <i class="fa-solid fa-pen-to-square" style="color:white;"></i>
                </button>

                <button class="btn btn-danger btn-sm delete" id="{{ $team->id }}" title="Usuń">
